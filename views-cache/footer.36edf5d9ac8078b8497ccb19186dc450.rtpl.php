<?php if(!class_exists('Rain\Tpl')){exit;}?><footer>
    ...
    <script src="/res/site/js/cidades_estados.json"></script>
    <script src="/res/site/js/buscacidade.js"></script>
    <script src="/res/site/js/controller.js"></script>
    <script src="/res/site/js/utils.js"></script>
    <script src="/res/site/js/aos.js"></script>
    <script>
     AOS.init();

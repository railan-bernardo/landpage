<?php if(!class_exists('Rain\Tpl')){exit;}?><header class="main-header-full">
    ...
    <div class="row row-flex">
        ...
        <div class="box-logo">
            ...
            <img src="/res/site/assets/images/marca_dagua_escura.png" alt="Escola de curso de manutenção em smartphone " title="Escola de curso de manutenção em smartphone">
...
<div class="black">
    <img src="/res/site/assets/images/background-mobol.png">
</div>
    ...
    <article class="rol-5 box-title" data-aos="zoom-in">
        ...
        <header class="content-title">
            ...
            <h1>Curso de Manutenção em Smartphones Nível I ao III</h1>
            ...
            <h2>Mês dos Pais</h2>
            <h3>Curso de Manutenção +Software Livres<h3>
            <div class="t_footer">
                <span>De R$ <del>2000,00</del> Por</span>

                <div class="preco_t">
                    <span>134,00 <small>12x</small></span>
                    <span>sem juros</span>
                    <p>Vagas limitdas e turmas reduzidas!</p>
                </div>
            </div> -->
        </header>
    ...
    <article class="rol-5 box-form" data-aos="flip-right">
        ...
        <form class="form" action="/create" method="POST" autocomplete="off">
            ...
            <div class="alert success"><?php echo htmlspecialchars( $msgSuccess, ENT_COMPAT, 'UTF-8', FALSE ); ?></div>
            <?php } ?>
            ...
            <div class="form-group">
                    ...
                    <input type="text" name="desaluno" placeholder="Seu nome..." autocomplete="off" required/>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="desemail" placeholder="Seu email..." autocomplete="off" required/>
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="nrphone" placeholder="(DDD) 00000-0000" required autocomplete="off"/>
                ...
                <div class="form-group">
                    ...
                    <label>Estado</label>
                    <select name="desstate" id="estados" required>
                        <option></option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <label>Cidade</label>
                    <select name="descity" id="cidades" required>
                ...
                <div class="form-group">
                    ...
                    <label>Curso</label>
                         ...
                         <input type="text"  name="descurso" value="Manutenção Smartphones I ao III"/>

                    </div>

                    <div class="form-group">
                        <input type="hidden"  name="idperson" value="5"/>
                        <input type="hidden"  name="countlead" value="5"/>
                        <input type="hidden"  name="desturno" value="vazio"/>
                          <input type="hidden"  name="desunity" value="vazio"/>
                        ...
                        <div class="form-group">
                            <input type="hidden"  name="descontent" value="vazio"/>
                              <input type="hidden"  name="desboubt" value="vazio"/>
                          </div>
                          
                             <div class="form-group">
                             <input type="hidden"  name="desprice" value="00.00"/>
                              <input type="hidden"  name="gdate" value="00-00-000"/>
                          </div>

                          <div class="form-group">
                            <input type="hidden"  name="desacount" value="Não informado"/>
                         </div>
                ...
                <input type="submit" class="button-env" value="Quero agendar minha ligação">
        ...
        <article class="service" data-aos="fade-rigth">
            ...
            <h2><span class="icon-social-foursquare"></span>Antes</h2>
                ...
                <div class="box-icon">
                   ...
                   <img src="/res/site/assets/images/icones/blogger.png" alt="Blog"/>
                ...
                <div class="box-icon box-zebra">
                   ...
                   <img src="/res/site/assets/images/icones/consutoria.png" alt="Consultoria"/>
                ...
                <div class="box-icon">
                   ...
                   <img src="/res/site/assets/images/icones/youtube.png" alt="YouTube"/>
        ...
        <article class="service" data-aos="fade-up">
            ...
            <div class="box-icon box-zebra">
                 ...
                 <span>Apostila</span>
                   ...
                   <img src="/res/site/assets/images/icones/lista.png" alt="Apostilha"/>
                ...
                <div class="box-icon">
                   ...
                   <img src="/res/site/assets/images/icones/bancada.png" alt="Bancada"/>
                ...
                <div class="box-icon zebra-mobil">
                   ...
                   <img src="/res/site/assets/images/icones/frete.png" alt="Fornecedor de peças"/>
                ...
                <div class="box-icon box-zebra bg-none">
                   ...
                   <img src="/res/site/assets/images/icones/iphone.png" alt="Iphone"/>
        ...
        <article class="service" data-aos="fade-down">
            ...
            <div class="box-icon zebra-mobil">
                  ...
                  <span>Certificado</span>
                   ...
                   <img src="/res/site/assets/images/icones/certificado.png" alt="Certificado"/>
                ...
                <div class="box-icon box-zebra bg-none">
                   ...
                   <img src="/res/site/assets/images/icones/pc.png" alt="Sistema Continuo de Treinamento"/>
                ...
                <div class="box-icon zebra-mobil">
                   ...
                   <img src="/res/site/assets/images/icones/telegram-group.png" alt="Grupo Telegram"/>
...
<div class="authores">
        ...
        <article class="profs" data-aos="zoom-in">
            ...
            <div class="box-image">
                ...
                <img src="/res/site/assets/images/alunos/uriel.png" alt="Aluno uriel"/>
        ...
        <article class="profs" data-aos="zoom-in-up">
            ...
            <div class="box-image">
                ...
                <img src="/res/site/assets/images/alunos/rosangela.png" alt="Aluna Rosangela"/>
        ...
        <article class="profs" data-aos="zoom-in-down">
            ...
            <div class="box-image">
                ...
                <img src="/res/site/assets/images/alunos/arthur.png" alt="Aluno Arthur"/>

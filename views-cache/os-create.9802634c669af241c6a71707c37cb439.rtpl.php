...
<div class="content-wrapper">
  ...
  <section class="content-header page_header_h1">
    <h1> Ordem de Serviço . <span>Nova OS</span></h1>
    <ol class="breadcrumb">
    ...
    <section class="content">
       ...
       <div class="row">
         <div class="col-md-12">
           <div class="box-panel">
                    <!-- /.box-header -->
               <form class="form-os" role="form" action="/admin/os/create" method="post">
                           <div class="box-body">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select name="id_os_client" class="form-control select2 select2-hidden-accessible" style="width: 100%;">
                                         <?php $counter1=-1;  if( isset($client) && ( is_array($client) || $client instanceof Traversable ) && sizeof($client) ) foreach( $client as $key1 => $value1 ){ $counter1++; ?>
                                           <option value="<?php echo htmlspecialchars( $value1["id_os_client"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["first_name"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                         <?php } ?>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <select name="id_services" class="form-control  select2 select2-hidden-accessible" style="width: 100%;">
                                        ...
                                        <option value="<?php echo htmlspecialchars( $value1["id_services"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><?php echo htmlspecialchars( $value1["name_product"], ENT_COMPAT, 'UTF-8', FALSE ); ?></option>
                                      <?php } ?>
                                      </select>
                                    </div>
                                  </div><!-- // -->
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="clerk" class="form-control" value='<?php echo getUserName(); ?>'>
                                    </div>
                                  </div><!-- // -->
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label for="customer_report">Relato do cliente</label>
                                      <textarea name="customer_report" class="form-control"></textarea>
                                    </div>
                                  </div><!-- // -->
                                  <div class="main-service">
                                    <div class="col-md-12">
                                      <label for="id_stock">Item</label>
                                      <div class="form-group">
                                        
                                        <div class="col-md-7" style="padding-left: 0;">
                                          <select name="id_stock" class="form-control  select2 select2-hidden-accessible" style="width: 100%;">
                                            <option selected value="1">Em analise Técnica</option>
                                       ...
                                       <div class="col-md-2">
                                        ...
                                        <div class="col-md-1">
                                          <input type="number" name="amount_qtd_os"  class="form-control" value="0">
                                        </div>
                                        <div class="col-md-2" style="padding-right: 0;">
                                          <input type="text" disabled class="form-control" value="Unidade">
                                          <input type="hidden" name="found_defect" value="">
                                          <input type="hidden" name="responsible_technician" value="">

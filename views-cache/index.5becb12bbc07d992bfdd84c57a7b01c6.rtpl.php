        ...
        <!-- Main content -->
             <section class="content">
                  <div class="row">
                      ...
                      <?php $counter1=-1;  if( isset($niver) && ( is_array($niver) || $niver instanceof Traversable ) && sizeof($niver) ) foreach( $niver as $key1 => $value1 ){ $counter1++; ?>
                      <div class="col-lg-12 col-xs-6">
                          <!-- small box -->
                          <div class="small-box bg-red" id="small-box-niver">
                              <div class="inner">
                                  <h3 style="text-transform: uppercase; overflow: hidden;">

                                      <?php echo htmlspecialchars( $value1["desname"], ENT_COMPAT, 'UTF-8', FALSE ); ?>

                                  </h3>
                                  <p>Anivesáriante do dia</p>
                              </div>
                              <div class="icon" style="overflow: hidden;">
                                  <img style=" width: 150px; object-fit: contain;" src="">
                              </div>
                          </div>
                      </div>
                      ...
                      <?php $counter1=-1;  if( isset($alert) && ( is_array($alert) || $alert instanceof Traversable ) && sizeof($alert) ) foreach( $alert as $key1 => $value1 ){ $counter1++; ?>
                      <div class="col-lg-12 col-xs-6">
                          <!-- small box -->
                          <div class="small-box bg-red">
                              <div class="inner">
                                  ...
                                  <p>Evento <?php echo htmlspecialchars( $value1["desclass"], ENT_COMPAT, 'UTF-8', FALSE ); ?> é Hoje</p>
                              </div>
                              <div class="icon" style="overflow: hidden;">
